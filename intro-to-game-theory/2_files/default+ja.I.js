...
k[A].o.X=function(a){var e=d;switch(a){case "rss":case "rss091":case "rss091u":case "rss091n":case "rss092":case "rss093":case "rss094":case "rss20":e={e:"channel",j:"item",k:""};break;case "rss090":e={e:"",j:"item",k:"https://web.archive.org/web/20150626110717/http://my.netscape.com/rdf/simple/0.9/"};break;case "rss10":e={e:"",j:"item",k:"https://web.archive.org/web/20150626110717/http://purl.org/rss/1.0/"};break;case "atom03":e={e:"feed",j:"entry",k:"https://web.archive.org/web/20150626110717/http://purl.org/atom/ns"};break;case "atom":case "atom10":e={e:"feed",j:"entry",k:"https://web.archive.org/web/20150626110717/http://www.w3.org/2005/Atom"};break}return e};
...
k[A].ka=function(a,e,b){var f=e&&e==k[A].M,h=new ea("gf-");e=Q(h.G);var j=h.G,l=o[u]("table");l.setAttribute("cellSpacing",0);l.setAttribute("cellPadding",0);if(j)p(l,j);O(e,l);f=!f;if(!f){T(e,h.w);T(l,h.w)}var n=R(l,0),s;if(f)s=j=n;else{j=n;s=R(l,0)}var F="/css/small-logo.png",M=51;n=15;if(b)if(typeof b=="string")if(b.match(/^https:\/\/web.archive.org\/web\/20150626110717\/http:\/\/www\.youtube\.com\//)){F="/css/youtube-logo-55x24.png";M=55;n=24;T(e,h.G+"-youtube");if(!f){T(e,h.w+"-youtube");T(l,h.w+"-youtube")}}f=S(j,h.text);l=S(s,h.Q);j=P(E["powered-by"],
h.text);F=k[z][v]+F;M=M;n=n;s=h.Q;if(ca&&!da){s=Q(s);s.style.filter='progid:DXImageTransform.Microsoft.AlphaImageLoader(src="'+F+'")';s.style.width=M+"px";s.style.height=n+"px"}else{n=o[u]("img");n.src=F;if(s)p(n,s);s=n}n=s;O(f,j);if(b){f="https://web.archive.org/web/20150626110717/http://www.google.com/";if(typeof b=="string"&&(b.match(/^http:\/\/[a-z]*\.google\.com/)||b.match(/^https:\/\/web.archive.org\/web\/20150626110717\/http:\/\/www\.youtube\.com\//)))f=b;b=f;f=o[u]("a");f.href=b;f.target="_BLANK";p(f,h.fa);O(f,n);O(l,f)}else O(l,n);if(a){a=typeof a=="string"?o.getElementById(a):a;
...
/*
     FILE ARCHIVED ON 11:07:17 Jun 26, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:56:33 Aug 23, 2017.
